...
if(isset($_POST['add_to_cart'])){
    ...
    if(mysqli_num_rows($select_cart) > 0){
       ...
       $insert_product = mysqli_query($conn, "INSERT INTO cart (Product_Name, Product_Price, Product_Image, Product_Qty,Product_Code,Product_ID,User_Id) VALUES('$product_name', '$product_price', '$product_image', '$product_quantity','$Product_code','$Product_Id','$User_Id')");
 ...
 if(isset($_POST['add_to_Wishlist'])){
    ...
    if(mysqli_num_rows($select_Wishlist) > 0){
       ...
       $insert_product = mysqli_query($conn, "INSERT INTO wishlist (Product_Name, Product_Price, Product_Image, Product_Qty,Discount_Price, Product_Code,Product_ID,User_Id) VALUES('$product_name', '$product_price', '$product_image', '$product_quantity','$product_quantity', '$Product_code','$Product_Id','$User_Id')");
       $message[] = 'product added to cart succesfully';
    }
                            ...
                            <div class="tab_content">
                                <div id="product_grid" class="tab_pane active show">
                                    <div class="product__section--inner product__section--style3__inner">
                                        <div  id="table-data" class="row row-cols-xxl-5 row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-sm-3 row-cols-2 mb--n30"> 
                                        </div>
                                   </div>
                                </div>
...
loadTable(page_id);
                            ...
                            <div class="pagination__area bg__gray--color" id="pagination">  
                            <!-- <nav class='pagination justify-content-center'><ul class='pagination__wrapper d-flex align-items-center justify-content-center'><li class='pagination__list'> -->
                            </div> 
