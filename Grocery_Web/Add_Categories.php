...
if(isset($_POST['cat_btn']))
{
  ...
  if(isset($_FILES['image']) && $_FILES['image']['error'] == 0)
	...
	if(file_exists("admin/Image_Categories/".$FName))
	{
	...
	else
	{
		...
		move_uploaded_file($_FILES['image']['tmp_name'], "admin/Image_Categories/".$FName);
		$Success= "File Successfully Uploaded";
		$uploaded ="admin/Image_Categories/".$FName;
...
$response = insert("categories",array('Category_Name' => $Category_Name,'Category_Img' => $uploaded));
        ...
        <div class="col-xl-12 col-md-12">
          <div class="ms-panel ms-panel-fh">
            <div class="ms-panel-header">
              <h6>Add Categories Form</h6>
            </div>
            <div class="ms-panel-body">
              <form class="needs-validation clearfix" action="Add_Categories.php" method="POST" novalidate enctype="multipart/form-data">
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom18">Category Name</label>
                    <div class="input-group">
                      <input type="text" name="cat_name" class="form-control" id="validationCustom18" placeholder="Category Name" value="" required>
                  ...
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom12">Category Image</label>
