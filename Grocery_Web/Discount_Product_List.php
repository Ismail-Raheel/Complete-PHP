...
$response = select("discount_product",array());
...
$responses = delete("discount_product",array('Discount_Product_Id' => $id));
              ...
              <div class="ms-panel-body">
                ...
                <div class="table-responsive">
                  <table class="table table-hover thead-primary">
                    <thead>
                      <tr>
                        <th scope="col">Discount_Product_Id</th>
                    ...
                    ?>
                      ...
                      <tr>
                       ...
                       <?php echo "<a href='Edit_Descount.php?pid=".$row['Discount_Product_Id']."'><i class='fas fa-pencil-alt text-secondary'></i></a>" ?> 
                       
                    <?php  echo "<a onClick=\"javascript:return confirm('Are you Sure You want To delete ?');\" href='Discount_Product_List.php?pid=".$row['Discount_Product_Id']."'><i class='far fa-trash-alt ms-text-danger'></i></a></td> "?>
                        </tr>
