...
$response = select("categories",array('Category_Id' => $id));
...
$response = Update("categories",array("Category_Name" => $Cat_Name, "Category_Img" => $uploaded),array('Category_Id' => $Pid));
        ...
        <div class="col-xl-12 col-md-12">
          <div class="ms-panel ms-panel-fh">
            ...
            <?php
              ...
              <form class="needs-validation clearfix" action="Edit_Categories.php" method="POST"  enctype="multipart/form-data">
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom18">Category Name</label>
                    <div class="input-group">
                        <input type="hidden" value="<?php echo $v['Category_Id'] ?>" name="Id">
                      <input type="text" value="<?php echo $v['Category_Name'] ?>" name="cat_name" class="form-control" id="validationCustom18" placeholder="Category Name">
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="custom-file">
                      <input type="file" name="image" value="<?php echo $v['Category_Img'] ?>" class="custom-file-input" id="validatedCustomFile">
                      <input type="hidden" name="HiddenPicPath1"  value="<?php echo $v['Category_Img'] ?>">
                  ...
                  <div class="col-md-12 mb-3">
                  <img src="<?php echo $v['Category_Img'] ?>" name="image" style="height:100px;width:100%" alt="">
...
<br>
                  ...
                  <button class="btn btn-secondary d-block" name="btn_Update" type="submit">Save</button>
