...
$response = select("categories",array());
...
if(isset($_POST['P_btn']))
{
  ...
  if(isset($_FILES['Main_Image']) && $_FILES['Main_Image']['error'] == 0)
	...
	else
	{
		...
		move_uploaded_file($_FILES['Main_Image']['tmp_name'], "admin/Main_Image/".$FName);
...
$Product_Des = $_POST['P_Desc'];
$Available_Stock = $_POST['P_Qty'];
$Category_Name = $_POST['C_Name'];




$response = insert("simple_products",array('Product_Name' => $Product_Name,'Product_Price' => $Product_Price,'Product_Des' => $Product_Des,'Available_Stock' => $Available_Stock,'Category_Id' => $Category_Name,'Product_Main_Picture' => $uploaded));
                ...
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" name="P_Name" class="form-control" id="validationCustom18" placeholder="Product Name" value="" required>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="number" name="P_Qty" class="form-control" id="validationCustom24" placeholder="01" required>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="number" name="P_Price" class="form-control" id="validationCustom25" placeholder="Rs:" required>
                      <div class="invalid-feedback">
                        Price
                      </div>
                    </div>
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <textarea rows="5"  name="P_Desc" id="validationCustom12" class="form-control" placeholder="Message" required></textarea>
                      <div class="invalid-feedback">
