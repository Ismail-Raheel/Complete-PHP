...
<!-- Mirrored from metropolitanhost.com/themes/themeforest/html/costic/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Aug 2022 11:50:51 GMT -->
<head>
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="index-2.html">
        <img src="admin/assets/img/costic/costic-logo-216x62.png" alt="logo">
      </a>
    </div>
    <!-- Navigation -->
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      <!-- Dashboard -->
      <li class="menu-item">
        <a href="Dashboard.php"> <span><i class="material-icons fs-16">dashboard</i>Dashboard </span>
        </a>
      ...
      <li class="menu-item">
      <a href="#" class="has-chevron" data-toggle="collapse" data-target="#invoice" aria-expanded="false" aria-controls="invoice"> <span><i class="fas fa-file-invoice fs-16"></i>Category </span>
        </a>

           <ul id="invoice" class="collapse" aria-labelledby="invoice" data-parent="#side-nav-accordion">
          <li> <a href="Add_Categories.php">Add Category</a>
          </li>
          <li> <a href="List_Categories.php">Category List</a>
          </li>
        </ul>
      </li>
      ...
      <li class="menu-item">
        ...
        <li> <a href="Menu_List.php">List Menu </a></li>
        <li> <a href="Product_Grid.php">Grid Menu </a></li>
        <li> <a href="Add_Product.php">Add Menu</a></li>
      ...
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#discount" aria-expanded="false" aria-controls="discount"> <span><i class="fas fa-clipboard-list fs-16"></i>Discount Products </span>
        </a>
        
        <ul id="discount" class="collapse" aria-labelledby="discount" data-parent="#side-nav-accordion">
        <li> <a href="Add_Descount.php">Add Discount  </a></li>
        <li> <a href="Discount_Product_List.php">Discount Product List </a></li>
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="index-2.html"><img src="admin/assets/img/costic/costic-logo-84x41.png" alt="logo"> </a>
      </div>
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
            ...
            <li class="ms-scrollable ms-dropdown-list">
              <a class="media p-2" href="#">
                <div class="ms-chat-status ms-status-offline ms-chat-img mr-2 align-self-center">
                  <img src="admin/assets/img/costic/customer-3.jpg" class="ms-img-round" alt="people">
                </div>
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="ms-user-img ms-img-round float-right" src="admin/assets/img/costic/customer-6.jpg" alt="people">
          </a>
          <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
            ...
            <li class="dropdown-menu-footer">
              <a class="media fs-14 p-2" href="Admin_Lock.php"> <span><i class="flaticon-security mr-2"></i> Lock</span>
              </a>
            </li>
            <li class="dropdown-menu-footer">
              <a class="media fs-14 p-2" href="Admin_Login.php"> <span><i class="flaticon-shut-down mr-2"></i> Logout</span>
              </a>
            </li>
          </ul>
        </li>
