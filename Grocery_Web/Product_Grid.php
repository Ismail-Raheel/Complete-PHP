...
$response = select("simple_products",array());

if(isset($_GET['pid']))
{
$id = $_GET['pid'];

$responses = delete("simple_products",array('Product_Id' => $id));

if($responses['status'] == "Success")

{
 
  echo"<script>window.location='Product_Grid.php';</script>";
}
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="ms-card">
              <div class="ms-card-img">
                <img src="<?= $row['Product_Main_Picture'] ?>" alt="card_img">
              </div>
              <div class="ms-card-body">

                <div class="new">
                  <h6 class="mb-0"><?= $row['Product_Name'] ?> </h6>
                  <h6 class="ms-text-primary mb-0"><?= $row['Product_Price'] ?> </h6>
                </div>
                <div class="new meta">
                  <p>Qty:<?= $row['Available_Stock'] ?>  </p>
                  <span class="badge badge-success">In Stock</span>
                </div>
                <p><?= $row['Product_Des'] ?>  </p>
                <div class="new mb-0">
                <?php   echo "<a onClick=\"javascript:return confirm('Are you Sure You want To delete ?');\" href='Product_Grid.php?pid=".$row['Product_Id']."' >  <button type='button' class='btn grid-btn mt-0 btn-sm btn-primary'>Remove</button></a>" ?>
               

                <?php   echo "<a href='Edit_Products.php?pid=".$row['Product_Id']."' >    <button type='button' class='btn grid-btn mt-0 btn-sm btn-secondary'>Edit</button></a>" ?>
