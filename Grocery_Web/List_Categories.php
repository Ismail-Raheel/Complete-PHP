...
$responses = delete("categories",array('Category_Id' => $id));
                  ...
                  <table class="table table-hover thead-primary">
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <th><img src="<?= $row['Category_Img']; ?>" alt=""></th>

                        <td>
                       
                       <?php echo "<a href='Edit_Categories.php?pid=".$row['Category_Id']."'><i class='fas fa-pencil-alt text-secondary'></i></a>" ?> 
                       
                    <?php  echo "<a onClick=\"javascript:return confirm('Are you Sure You want To delete ?');\" href='List_Categories.php?pid=".$row['Category_Id']."'><i class='far fa-trash-alt ms-text-danger'></i></a></td> "?>
                        </tr>
