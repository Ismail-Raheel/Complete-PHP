...
$responses = select("categories",array());
...
$response = select("simple_products",array('Product_Id' => $id));
...
if(isset($_POST['btn_Update']))
{
    ...
    // if($uploaded['Category_Img'] == NULL)
    // {

    //     $imageName = $_POST('HiddenPicPath1');
    //     $uploaded = $imageName;
  ...
  if(isset($_FILES['Main_Image']) && $_FILES['Main_Image']['error'] == 0)
	...
	$FType = $_FILES['Main_Image']['type'];
	$FSize = $_FILES['Main_Image']['size'];
	$Ext = pathinfo($FName,PATHINFO_EXTENSION);
	
	if(!array_key_exists($Ext,$AllowedFormet))
	{
	...
	if($Error = "" || in_array($FType,$AllowedFormet))
	{
	
	
	if(file_exists("admin/Main_Image/".$FName))
	{
	
	$Error = "$FName Already Exists in Folder";
	...
	else
	{
		...
		move_uploaded_file($_FILES['image']['tmp_name'], "admin/Main_Image/".$FName);
		$Success= "File Successfully Uploaded";
		$uploaded ="admin/Main_Image/".$FName;
...
$response = Update("simple_products",array("Product_Name" => $Cat_Name, "Category_Img" => $uploaded),array('Category_Id' => $Pid));
        ...
        <div class="col-xl-12 col-md-12">
          <div class="ms-panel ms-panel-fh">
            ...
            <?php
              ...
              <form class="needs-validation" action="Add_Product.php" method="POST" enctype="multipart/form-data">

                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    <label for="validationCustom18">Product Name</label>
                    <div class="input-group">
                      <input type="text" name="P_Name" class="form-control" id="validationCustom18" placeholder="Product Name" value="<?= $v['Product_Name'] ?>" required>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="number" name="P_Qty" class="form-control" id="validationCustom24" placeholder="01" value="<?= $v['Available_Stock'] ?>" required>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="number"  value="<?= $v['Product_Price'] ?>" name="P_Price" class="form-control" id="validationCustom25" placeholder="Rs:" required>
                      <div class="invalid-feedback">
                        Price
                      </div>
                    </div>
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <select class="form-control" name="C_Name" id="validationCustom22">
                      
                          
                    <?php  foreach($responses["data"] as $row)
                    {
                    ?>
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <textarea rows="5"
                       ...
                       name="P_Desc" id="validationCustom12"  class="form-control" placeholder="Message" required></textarea>
                      <div class="invalid-feedback">
...
<img src="<?= $v['Product_Main_Picture'] ?>" style="height:70px; width: 100%;" alt="">
</div>
...
<div class="col-md-8 col-lg-8">
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="custom-file">
                      ...
                      <input type="file"   name="Main_Image" class="custom-file-input" id="validatedCustomFile">
                  ...
                  <div class="row" style="padding:20px">
                  <div class="col-md-6 mb-3">
                    <label for="validationCustom12">Sub Image 1</label>
                    <div class="custom-file">
                      <input type="file"  name="Sub_img_1" class="custom-file-input" id="validatedCustomFile">
                      <label class="custom-file-label" for="validatedCustomFile">Upload Images...</label>
                      <div class="invalid-feedback">Example invalid custom file feedback</div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 mb-3">
                  <label for="validationCustom12">Sub Image 2</label>
                    <div class="custom-file">
                      <input type="file"  name="Sub_img_2" class="custom-file-input" id="validatedCustomFile">
                      <label class="custom-file-label" for="validatedCustomFile">Upload Images...</label>
                      <div class="invalid-feedback">Example invalid custom file feedback</div>
                    </div>
                  </div>
                  ...
                  <label for="validationCustom12">Sub Image 3</label>
                    <div class="custom-file">
                      <input type="file"  name="Sub_img_3" class="custom-file-input" id="validatedCustomFile">
                      <label class="custom-file-label" for="validatedCustomFile">Upload Images...</label>
                      <div class="invalid-feedback">Example invalid custom file feedback</div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4 mb-3">
                  <label for="validationCustom12">Sub Image 4</label>
                    <div class="custom-file">
                      <input type="file"  name="Sub_img_4" class="custom-file-input" id="validatedCustomFile">
                      <label class="custom-file-label" for="validatedCustomFile">Upload Images...</label>
                      <div class="invalid-feedback">Example invalid custom file feedback</div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4 mb-3">
                  <label for="validationCustom12">Sub Image 5</label>
                    <div class="custom-file">
                      <input type="file"  name="Sub_img_5" class="custom-file-input" id="validatedCustomFile">
                      <label class="custom-file-label" for="validatedCustomFile">Upload Images...</label>
                      <div class="invalid-feedback">Example invalid custom file feedback</div>
                    </div>
                  </div>
                 ...
                 <br>
                <button class="btn btn-secondary d-block" name="P_btn" type="submit">Save</button>
                  ...
                  <div id="imagesSlider" class="ms-image-slider carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="admin/assets/img/costic/add-product-1.jpg" alt="First slide">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="admin/assets/img/costic/add-product-2.jpg" alt="Second slide">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="admin/assets/img/costic/add-product-3.jpg" alt="Third slide">
                      </div>
                    </div>
                    <ol class="carousel-indicators">
                      <li data-target="#imagesSlider" data-slide-to="0" class="active"> <img class="d-block w-100" src="admin/assets/img/costic/add-product-1.jpg" alt="First slide"></li>
                      <li data-target="#imagesSlider" data-slide-to="1"><img class="d-block w-100" src="admin/assets/img/costic/add-product-2.jpg" alt="Second slide"></li>
                      <li data-target="#imagesSlider" data-slide-to="2"><img class="d-block w-100" src="admin/assets/img/costic/add-product-3.jpg" alt="Third slide"></li>
                    </ol>
                  </div>
                </div>
          ...
          <div class="ms-quickbar-container ms-scrollable">
            ...
            <div class="ms-card ms-qa-card ms-deletable">
              ...
              <div class="ms-card-body">
                ...
                <ul class="ms-note-members clearfix mb-0">
                  <li class="ms-deletable"> <img src="admin/assets/img/people/people-3.jpg" alt="member"> </li>
                  <li class="ms-deletable"> <img src="admin/assets/img/people/people-5.jpg" alt="member"> </li>
                </ul>
              </div>
              <div class="ms-card-footer clearfix">
                    ...
                    <li class="ms-scrollable ms-dropdown-list ms-members-list">
                      <a class="media p-2" href="#">
                        <div class="mr-2 align-self-center">
                          <img src="admin/assets/img/people/people-10.jpg" class="ms-img-round" alt="people">
                        </div>
                      ...
                      <a class="media p-2" href="#">
                        <div class="mr-2 align-self-center">
                          <img src="admin/assets/img/people/people-9.jpg" class="ms-img-round" alt="people">
                        </div>
                        <div class="media-body">
                      ...
                      <a class="media p-2" href="#">
                        <div class="mr-2 align-self-center">
                          <img src="admin/assets/img/people/people-7.jpg" class="ms-img-round" alt="people">
                        </div>
                        <div class="media-body">
            ...
            <div class="ms-card ms-qa-card ms-deletable">
              ...
              <div class="ms-card-body">
                ...
                <ul class="ms-note-members clearfix mb-0">
                  <li class="ms-deletable"> <img src="admin/assets/img/people/people-9.jpg" alt="member"> </li>
                </ul>
              </div>
              <div class="ms-card-footer clearfix">
