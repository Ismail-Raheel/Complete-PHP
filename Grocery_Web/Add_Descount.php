...
$responses = select("simple_products",array());
...
$response = insert("discount_product",array('Start_Date' => $S_Date,'End_Date' => $E_Date,'Selling_Price' => $N_Price,'Product_Id' => $P_Id));
        ...
        <div class="col-xl-12 col-md-12">
          <div class="ms-panel ms-panel-fh">
            ...
            <div class="ms-panel-body">
              <form class="needs-validation clearfix" action="Add_Descount.php" method="POST" novalidate enctype="multipart/form-data">
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                    <label for="validationCustom18">Start Date </label>
                    <div class="input-group">
                      <input type="date" name="S_Date" class="form-control" id="validationCustom18" placeholder="Category Name" value="" required>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="date" name="E_Date" class="form-control" id="validationCustom18" placeholder="Category Name" value="" required>
                      <div class="valid-feedback">
                        Looks good!
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="number" name="N_Price" class="form-control" id="validationCustom18" placeholder="Product Price" value="" required>
                      <div class="valid-feedback">
                        Looks good!
                      </div>
                    </div>
                  ...
                  <button class="btn btn-secondary d-block" name="cat_btn" type="submit">Save</button>
