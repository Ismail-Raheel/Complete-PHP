...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <li class="menu-item">
        <a href="pages/widgets.html"> <span><i class="material-icons fs-16">widgets</i>Categories</span>
        </a>
      </li>
      ...
      <li class="menu-item">
        ...
        <!-- <li> <a href="Product_Details.php">Product Detail</a></li> -->
        </ul>
      </li>
      ...
      <!-- orders -->
      <li class="menu-item">
        <a href="Order_Details.php"> <span><i class="fas fa-clipboard-list fs-16"></i>Orders</span>
        </a>
      </li>
      <!-- orders end -->
      <!-- restaurants -->
