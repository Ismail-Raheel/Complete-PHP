...
<body class="ms-body ms-primary-theme">
        ...
        <li class="ms-scrollable ms-dropdown-list">
          <a class="media p-2" href="#">
            <div class="ms-chat-status ms-status-offline ms-chat-img mr-2 align-self-center">
              <img src="admin/assets/img/people/people-3.jpg" class="ms-img-round" alt="people">
            </div>
          ...
          <a class="media p-2" href="#">
            <div class="ms-chat-status ms-status-online ms-chat-img mr-2 align-self-center">
              <img src="admin/assets/img/people/people-5.jpg" class="ms-img-round" alt="people">
            </div>
            <div class="media-body">
  ...
  <main class="body-content ms-lock-screen">
    ...
    <div class="ms-content-wrapper">
      <img class="ms-user-img ms-img-round ms-lock-screen-user" src="admin/assets/img/costic/customer-3.jpg" alt="people">
      <h1>John Doe</h1>
      <form method="post">
        ...
        <a href="../../index-2.html" class="btn bg-black w-100">Unlock</a>
      </form>
