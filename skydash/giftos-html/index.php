...
$uid=$_SESSION['id'];
$sqlssss="SELECT * FROM `add_to_cart`,products,category WHERE products.p_id = add_to_cart.p_id AND category.cat_id = add_to_cart.c_id AND add_to_cart.u_id = $uid";
$rrr=mysqli_query($conn,$sqlssss);
// $rowss=mysqli_fetch_array($rrr);
 ...
 ?>
  ...
  <div class="row g-0">
  <div class="col-md-4">
      <img src="<?php echo "../prodimages/".$rowss['p_img'];  ?>" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title"><?php echo $rowss['p_name']; ?></h5>
        <p class="card-text"><?php echo $rowss['p_price']; ?></p>
        <p class="card-text"><small class="text-body-secondary"><?php echo $rowss['cat_name']; ?></small></p>
        <a href="atcdel.php?id=<?php echo $rowss['atc_id']; ?>"><i class="fa fa-trash"></i></a>
      </div>
    </div>
  </div>
...
?>
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="<?php echo "../prodimages/".$row['p_img']; ?>" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  <?php echo $row['p_name']; ?>
